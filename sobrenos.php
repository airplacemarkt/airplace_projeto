...
<br>
  ...
  <section class="presentation">
    <div class="text">
        <br>
      <h2>Nossa Missão</h2>
      <p>A nossa missão é reunir diversos vendedores de drones, oferecendo uma variedade de modelos e opções para consumidores que buscam soluções específicas.</p>
      <br>
      <h2>Visão</h2>
      <p>Transformar a forma como drones são comprados e usados, facilitando o acesso à tecnologia para todos, com segurança e inovação.</p>
      <br>
      <h2>Valores</h2>
      <p>Valorizamos principlamente a inovação tecnológica, segurança e confiabilidade dos produtos.</p>
    </div>
    <div class="image">
      <img src="imagens/Drone-PNG-Transparent-Image (1).png" alt="Drone em Detalhe">
    </div>
  </section>
  ...
  <section class="gallery">
    ...
    <div class="gallery-container">
      <div class="gallery-slider">
        <img src="imagens/Drone1.jpg" alt="Drone 1">
        <img src="imagens/Drone2.jpg" alt="Drone 2">
        <img src="imagens/Drone3.jpg" alt="Drone 3">
      </div>
    </div>
  ...
  <section class="values">
    <div class="value">
      <img src="imagens/logo_drone_black.png" alt="Confiabilidade">
      <h3>Confiabilidade</h3>
      <p style="text-align: justify; padding-right: 5%;">No Air Place, a confiabilidade é prioridade. Com vendedores verificados, produtos de qualidade garantida e transações seguras, oferecemos uma experiência de compra tranquila e segura. Comprar drones no Air Place é sinal que preserva a qualidade de um produto.</p>
    </div>
    <div class="value">
      <img src="imagens/logo_drone_black.png" alt="Sustentabilidade">
      <h3>Sustentabilidade</h3>
      <p style="text-align: justify; padding-right: 5%;">No Air Place, acreditamos que a sustentabilidade é parte fundamental do futuro dos drones. Trabalhamos com fornecedores comprometidos com práticas responsáveis e oferecemos opções de reuso e reciclagem para reduzir o impacto ambiental. Com inovação consciente, promovemos um mercado sustentável para todos.</p>
    </div>
    <div class="value">
      <img src="imagens/logo_drone_black.png" alt="Inovação">
      <h3>Inovação</h3>
      <p style="text-align: justify;">No Air Place, a inovação é o que nos move. Nosso marketplace oferece as mais avançadas tecnologias em drones, reunindo funcionalidades que transformam a experiência do usuário. Com foco em evolução constante, o Air Place conecta você ao que há de mais moderno no mercado. Principalmente a mais nova novidade, entregas delivery feitas por drones.</p>
    </div>
  </section>
